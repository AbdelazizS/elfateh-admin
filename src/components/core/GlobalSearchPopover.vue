...
<template>
  <Popover :open="isFocused">
    ...
    <PopoverContent class="mt-2 w-[500px] h-96 custom_scroll z-[1000000000000000] ">
      <div class="pb-4">
        ...
        <ul>
          ...
          >
          <!-- violet -->
            <div class="rounded-md bg-primary/40 dark:bg-muted w-12 h-12 flex items-center justify-center me-4">
              <span class="text-primary/500 dark:text-foreground flex items-center"><Icon :name="menu.icon" /></span>
            </div>
            <div>
